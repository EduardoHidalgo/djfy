...
export namespace SpotifyApi {
  ...
  export interface UsersSavedAlbumsResponse
    extends PagingObject<SavedAlbumObject> {}
   ...
   */
  export type UsersSavedShowsResponse = PagingObject<SavedShowObject>;
   ...
   */
  export type UsersSavedEpisodesResponse = PagingObject<SavedEpisodeObject>;
   ...
   */
  export interface UsersTopArtistsResponse
    extends PagingObject<ArtistObjectFull> {}
   ...
   * https://developer.spotify.com/web-api/get-users-top-artists-and-tracks/
   */
  export interface UsersTopTracksResponse
    extends PagingObject<TrackObjectFull> {}
   ...
   */
  export type SingleShowResponse = ShowObject;
   ...
   */
  export type ShowEpisodesResponse = PagingObject<EpisodeObjectSimplified>;
   ...
   */
  export type SingleEpisodeResponse = EpisodeObject;
   ...
   */
  export interface ListOfUsersPlaylistsResponse
  ...
  export interface PlaylistTrackResponse
    extends PagingObject<PlaylistTrackObject> {}
   ...
   */
  export interface ChangePlaylistDetailsReponse
   ...
   */
  export interface ReplacePlaylistTracksResponse
    extends PlaylistSnapshotResponse {}
   ...
   */
  export interface UploadCustomPlaylistCoverImageResponse
    extends VoidResponse {}
  /**
   * Upload a Custom Playlist Cover Image
   *
   * PUT /v1/users/{user_id}/playlists/{playlist_id}/images
   ...
   */
  export interface UploadCustomPlaylistCoverImageReponse
   ...
   */
  export interface UsersFollowPlaylistReponse
    extends UsersFollowPlaylistResponse {}
   ...
   */
  export interface EpisodeObject extends EpisodeObjectSimplified {
    /**
   ...
   */
  export interface ShowObject extends ShowObjectSimplified {
    episodes: PagingObject<EpisodeObjectSimplified>;
    external_urls: ExternalUrlObject;
  }
